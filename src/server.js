...
// Create and configure Express app without starting server immediately
function createApp(options = {}) {
  // Allow overriding paths via options or environment
  const keyPath = options.keyPath || process.env.KEY_PATH || undefined;
  const storagePath = options.storagePath || process.env.DATA_PATH || undefined;
  ...
  const qrCodeGenerator = new QRCodeGenerator(baseUrl);
...
// If this file is run directly, start the server. Otherwise export createApp
